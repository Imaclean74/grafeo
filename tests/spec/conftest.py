...
_runner_conftest = Path(__file__).resolve().parent / "runners" / "python" / "conftest.py"
_spec = importlib.util.spec_from_file_location("_gtest_runner_conftest", _runner_conftest)
